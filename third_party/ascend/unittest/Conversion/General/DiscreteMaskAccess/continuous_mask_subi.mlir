...
// Continuous mask written as (arange - C) >= 0 must be recognized by
// MaskState (via arith.subi). discrete-mask-access-conversion must NOT strip
// the mask into a full load + select.

// CHECK-LABEL: tt.func @continuous_mask_subi
// CHECK-NOT: arith.select
// CHECK: tt.load {{.*}}, %[[MASK:.*]]
// CHECK-NOT: arith.select
tt.func @continuous_mask_subi(%arg0: !tt.ptr<f32>, %arg1: !tt.ptr<f32>) {
