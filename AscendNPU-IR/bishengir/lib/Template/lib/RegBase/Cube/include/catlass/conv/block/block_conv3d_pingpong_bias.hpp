...
public:
        ...
        : conv3dParams(conv3dParams_)
    {
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(L1A_STAGES + L1B_STAGES);
    ...
    ~BlockConv()
    {
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(L1A_STAGES + L1B_STAGES);
        ...
        Conv3d6HdCoord const &actualBlockShape, Conv3d6HdCoord const &actualIdxStartFmap)
    {
        ...
        for (uint32_t batchIter = 0; batchIter < actualBlockShape.n(); ++batchIter) {
            ...
            while (true) {
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(L1A_STAGES + L1B_STAGES);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(L1A_STAGES + L1B_STAGES);
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_M>(L0A_STAGES + L0B_STAGES);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_M>(L0A_STAGES + L0B_STAGES);
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(L1A_STAGES + L1B_STAGES);

                if constexpr (!ENABLE_UNIT_FLAG) {
                    AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::FIX_M>(EVENT_ID0);
                }
                ...
                if constexpr (!ENABLE_UNIT_FLAG) {
                    AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_FIX>(EVENT_ID0);
                    AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_FIX>(EVENT_ID0);
                    copyL0CToGm(gmTileOut, l0CTensorList[l0CListId], layoutOutGm, layoutCInL0);
                    AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::FIX_M>(EVENT_ID0);
                } else {
...
protected:
                 ...
                 AscendC::GlobalTensor<ElementFilter> const &filterGm, LayoutFilter const &layoutFilter)
    {
        ...
        while (iterParams.kIter < iterParams.ddr2l0LoopK) {
            if (iterParams.loadAL1Flag || (!iterParams.kAL1fullload && iterParams.kIter % iterParams.multiKAL1 == 0)) {
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1AEventList[l1AListId]);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1AEventList[l1AListId]);
                LoadAL1Process(gmBatchFmap, iterParams.kIter / iterParams.multiKAL1, layoutFmap, l1AListId);
                iterParams.loadAL1Flag = false;
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1AEventList[l1AListId]);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1AEventList[l1AListId]);
            }
            if (iterParams.loadBL1Flag || (!iterParams.kBL1fullload && iterParams.kIter % iterParams.multiKBL1 == 0)) {
                AscendC::PipeBarrier<PIPE_ALL>();
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1BEventList[l1BListId]);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1BEventList[l1BListId]);
                LoadBL1Process(filterGm, iterParams.kIter / iterParams.multiKBL1, layoutFilter, l1BListId);
                iterParams.loadBL1Flag = false;
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1BEventList[l1BListId]);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1BEventList[l1BListId]);
            }
                             ...
                             AscendC::GlobalTensor<ElementFilter> const &filterGm, LayoutFilter const &layoutFilter)
    {
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1AEventList[l1AListIdNext]);
        LoadAL1Process(gmBatchFmap, 1, layoutFmap, l1AListIdNext);
        iterParams.loadAL1Flag = false;
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1AEventList[l1AListIdNext]);
        ...
        while (iterParams.kIter < iterParams.ddr2l0LoopK) {
            if (iterParams.kIter == maxKAL1PreloadIter) {
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1AEventList[l1AListIdNext]);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1AEventList[l1AListId]);
                             ...
                             AscendC::GlobalTensor<ElementFilter> const &filterGm, LayoutFilter const &layoutFilter)
    {
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1BEventList[l1BListIdNext]);
        LoadBL1Process(filterGm, 1, layoutFilter, l1BListIdNext);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1BEventList[l1BListIdNext]);
        ...
        while (iterParams.kIter < iterParams.ddr2l0LoopK) {
            ...
            if (iterParams.kIter == maxKBL1PreloadIter) {
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1BEventList[l1BListIdNext]);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1BEventList[l1BListId]);
    ...
    void ReduceKL0AL0BPingPong(const uint16_t& l0abFlag, uint32_t l1aListId, uint32_t l1bListId) {
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(l0AEventList[l0abFlag]);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(l0BEventList[l0abFlag]);
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_M>(l0AEventList[l0abFlag]);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_M>(l0BEventList[l0abFlag]);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_M>(l0AEventList[l0abFlag]);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_M>(l0BEventList[l0abFlag]);
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(l0AEventList[l0abFlag]);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(l0BEventList[l0abFlag]);
    }
};
}  // namespace Catlass::Conv::Block
