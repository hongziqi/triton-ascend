        ...
        for (uint32_t kIdx = 0; kIdx < kLoops; kIdx++)
        {
            ...
            if (shuffleKIdx != lastTileIdx)
            {
                ...
                if (ENABLE_ABBA)
                {
                    ...
                    {
                        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1BEventList[l1ListIdNext]);
                        ...
                        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1AEventList[l1ListIdNext]);
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1AEventList[l1ListId]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1BEventList[l1ListId]);
            ...
            for (uint32_t kL0Idx = 0; kL0Idx < kL0Loops; kL0Idx++)
            {
                ...
                if (ENABLE_ABBA)
                {
                    ...
                    {
                        if (kL0Idx % 2 == 0) {
                            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(l0BEventList[l0ListId]);
                            copyL1ToL0B(l0TileB, l1TileB, layoutBInL0, layoutBInL1);
                            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_M>(l0BEventList[l0ListId]);
                            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(l0AEventList[l0ListId]);
                            copyL1ToL0A(l0TileA, l1TileA, layoutAInL0, layoutAInL1);
                            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_M>(l0AEventList[l0ListId]);
                        } else {
                            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(l0AEventList[l0ListId]);
                            copyL1ToL0A(l0TileA, l1TileA, layoutAInL0, layoutAInL1);
                            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_M>(l0AEventList[l0ListId]);
                ...
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_M>(l0BEventList[l0ListId]);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_M>(l0AEventList[l0ListId]);
                tileMmad(l0CTensor[(singleIdx % l0CBlockNum) * BlockCnt], l0TileA, l0TileB, mActual, nActual, kL0Actual, (kIdx == 0) && (kL0Idx == 0));
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(l0AEventList[l0ListId]);
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(l0BEventList[l0ListId]);
                l0ListId = 1 - l0ListId;
            }
        }
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_FIX>((int32_t)(singleIdx % l0CBlockNum));
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_FIX>((int32_t)(singleIdx % l0CBlockNum));
