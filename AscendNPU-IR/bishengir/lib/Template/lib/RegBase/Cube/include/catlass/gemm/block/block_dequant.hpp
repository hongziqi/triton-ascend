...
public:
        ...
        uint32_t srcStride, uint32_t dstStride)
    {
        ...
        for (int ldx = 0; ldx < blockLoopInfo.totalLoop; ldx++) {
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(EventIdBufferForCast[bufferIndexForCast]);
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>(EventIdBufferForCast[bufferIndexForCast]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>(EventIdBufferForCast[bufferIndexForCast]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_V>(EventIdBufferForCast[bufferIndexForCast]);
            AscendC::Cast(
                output[bufferIndexForCast], input[bufferIndexForCast], AscendC::RoundMode::CAST_RINT, CAST_LENGTH);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE3>(EventIdBufferForCast[bufferIndexForCast]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE3>(EventIdBufferForCast[bufferIndexForCast]);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(EventIdBufferForCast[bufferIndexForCast]);
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_V>(EventIdBufferForCast[bufferIndexForCast]);
        ...
        uint32_t srcStride, uint32_t dstStride, half scalar, half zeroPoint, uint32_t &bufferIndex)
    {
        ...
        for (int ldx = 0; ldx < blockLoopInfo.totalLoop; ldx++) {
            ...
            loadStoreInfo.loopIdx = ldx;
            GetLoaderStorerInfo(blockLoopInfo, loadStoreInfo, srcStride, dstStride);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(EventIdBuffer[bufferIndex]);
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>(EventIdBuffer[bufferIndex]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>(EventIdBuffer[bufferIndex]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_V>(EventIdBuffer[bufferIndex]);
            Dequant(inputBuffer[bufferIndex],
                ...
                scalar,
                zeroPoint);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE3>(EventIdBuffer[bufferIndex]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE3>(EventIdBuffer[bufferIndex]);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(EventIdBuffer[bufferIndex]);
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_V>(EventIdBuffer[bufferIndex]);
