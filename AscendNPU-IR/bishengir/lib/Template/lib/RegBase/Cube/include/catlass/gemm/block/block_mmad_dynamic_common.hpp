        ...
        GemmCoord const &actualShape, GemmCoord const &actualShapeNext, bool isFirstBlock, bool hasNextBlock)
    {
        ...
        for (uint32_t kLoopIdx = 0; kLoopIdx < kTileCount; kLoopIdx++) {
            ...
            for (int kPartIdx = 0; kPartIdx < kPartLoop; kPartIdx++) {
                ...
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(l0AEventList[l0ABufId]);
                if (kPartIdx == 0) {
                ...
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(l0BEventList[l0BBufId]);
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(l0BEventList[l0BBufId]);

                l0BBufId = (l0BBufId + 1 < STAGES) ? (l0BBufId + 1) : 0;

                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(l0AEventList[l0ABufId]);
