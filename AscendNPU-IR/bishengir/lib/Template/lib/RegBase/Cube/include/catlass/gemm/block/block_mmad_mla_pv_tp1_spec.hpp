                    ...
                    uint32_t &blockSize, uint32_t kvSeqlen, Arch::CrossCoreFlag softmaxReady)
    {
        ...
        for (uint32_t embedSplitIdx = 0; embedSplitIdx < embedSplitLoopV; embedSplitIdx++) {
            ...
            for (uint32_t blockStackIdx = 0;
                ...
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(L1ABPingPongFlag + 4);
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(L1ABPingPongFlag);

                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(L1ABPingPongFlag);
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(L1ABPingPongFlag + 4);

                if (embedSplitIdx == 0 && blockStackIdx == 0) {
                    Arch::CrossCoreWaitFlag(softmaxReady);
                }
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(L1ABPingPongFlag + 6);
                ...
                copyGmToL1A(l1ATensor[L1ABPingPongFlag], gA[blockStackIdx * blockSize], layoutASplitKInL1,
                            layoutASplitK);
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(EVENT_ID7);
                // copy P to l0a
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(EVENT_ID7);
                ...
                copyL1ToL0A(l0ATensor[L0ABPingPongFlag], l1ATensor[L1ABPingPongFlag], layoutASplitKInL0,
                            layoutASplitKInL1);
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(L1ABPingPongFlag + 6);
