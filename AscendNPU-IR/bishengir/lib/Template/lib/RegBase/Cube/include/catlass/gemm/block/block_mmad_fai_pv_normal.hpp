...
public:
        ...
        uint32_t &nkblockLoop, bool firstItr, bool endItr, bool initMmad, bool pvCVItr, Arch::CrossCoreFlag softmaxFlag, bool preloadFlag = false)
    {
        ...
        if (pvCVItr) {
            Arch::CrossCoreWaitFlag(softmaxFlag);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(4);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(5);
            auto layoutATile = layoutA.GetTileLayout(MakeCoord(MActual, (uint32_t)512));
            copyGmToL1A(l1ATensor, gA, layoutAInL1, layoutATile);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(4);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(4);
        }
        ...
        if (endItr) {
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(4);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(5);
            if constexpr (!ENABLE_UNIT_FLAG_) {
