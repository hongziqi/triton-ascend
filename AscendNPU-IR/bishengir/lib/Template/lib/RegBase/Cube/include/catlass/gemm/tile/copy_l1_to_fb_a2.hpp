...
struct CopyL1ToFB<ArchTag, Catlass::Gemm::GemmType<ElementSrc, layout::VectorLayout, AscendCBisheng::TPosition::A1>,
    Catlass::Gemm::GemmType<ElementDst, layout::VectorLayout, AscendCBisheng::TPosition::C2PIPE2GM>>{
