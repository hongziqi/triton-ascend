...
public:
    ...
    BlockMmad(Arch::Resource<ArchTag> &resource, uint32_t l1BufAddrStart = 0)
    {
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(EVENT_ID2);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(EVENT_ID3);
    }
    ...
    ~BlockMmad()
    {
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(EVENT_ID2);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(EVENT_ID3);
    }
        ...
        Arch::CrossCoreFlag softmaxReady)
    {
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(pingpongFlag + PINGPONG_FLAG_OFFSET);
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(pingpongFlag + PINGPONG_FLAG_OFFSET);
