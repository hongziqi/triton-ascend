...
public:
    ...
    BlockEpilogue(Arch::Resource<ArchTag> &resource, uint32_t kvSplitCoreNum_)
    {
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_V>(EVENT_ID0);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(EVENT_ID0);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(EVENT_ID1);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(EVENT_ID2);
    }
    CATLASS_DEVICE
    ~BlockEpilogue()
    {
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_V>(EVENT_ID0);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(EVENT_ID0);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(EVENT_ID1);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(EVENT_ID2);
    }
        ...
        uint32_t actualHeads, uint32_t headsProcess, uint32_t headSize)
    {
        ...
        AscendC::DataCopyPad(
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>(EVENT_ID2);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>(EVENT_ID2);
        ...
        AscendC::DataCopyPad(
            ...
            AscendC::DataCopyPadExtParams<ElementInput>(false, 0, 0, 0));
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>(EVENT_ID0);

        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_S>(EVENT_ID2);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_S>(EVENT_ID2);
        ...
        for (uint32_t i = 0; i < kvSplitCoreNum; i++) {
            ...
            if (i < kvSplitCoreNum - 1) {
                ...
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(oInEventList[nextBufferId]);
                AscendC::DataCopyPad(
                    ...
                    AscendC::DataCopyExtParams(
                        ...
                        (kvSplitCoreNum * headSize - headSize) * sizeof(ElementInput), 0, 0),
                    AscendC::DataCopyPadExtParams<ElementInput>(false, 0, 0, 0));
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>(oInEventList[nextBufferId]);
            }

            AscendC::PipeBarrier<PIPE_V>();
            for (uint32_t j = 0; j < actualHeads; j++) {
                float a = lExp[j * KV_SPLIT_MAX + i].GetValue(0);
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::S_V>(oTempEventList[bufferId]);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::S_V>(oTempEventList[bufferId]);
            ...
            // caculate current o
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>(oInEventList[bufferId]);
            ...
            AscendC::PipeBarrier<PIPE_V>();
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(oInEventList[bufferId]);
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE3>(EVENT_ID0);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE3>(EVENT_ID0);
        AscendC::DataCopyPad(
            gOutput, out,
            AscendC::DataCopyExtParams(
