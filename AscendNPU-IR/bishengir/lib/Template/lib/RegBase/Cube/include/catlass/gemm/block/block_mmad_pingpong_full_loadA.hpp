...
public:
        ...
        GemmCoord const &actualShape, bool needLoadL1)
    {
        ...
        if (needLoadL1) {
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1AEventList[0]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1AEventList[0]);
            copyGmToL1A(l1ATensorList[0], gmA, layoutAInL1, layoutTileA);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1AEventList[0]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1AEventList[0]);
        }
