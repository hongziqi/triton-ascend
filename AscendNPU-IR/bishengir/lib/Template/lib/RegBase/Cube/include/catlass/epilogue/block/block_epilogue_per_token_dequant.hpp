...
public:
    ...
    BlockEpilogue(Arch::Resource<ArchTag> const &resource, Params const &params = Params{}) : params(params)
    {
        ...
        for (uint32_t i = 0; i < UB_STAGES; ++i) {
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(eventUbCVMTE2List[i]);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(eventUbScaleVMTE2List[i]);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(eventUbPerTokenScaleVMTE2List[i]);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_V>(eventUbDMTE3VList[i]);
        }
    ...
    {
        for (uint32_t i = 0; i < UB_STAGES; ++i) {
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(eventUbCVMTE2List[i]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(eventUbScaleVMTE2List[i]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(eventUbPerTokenScaleVMTE2List[i]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_V>(eventUbDMTE3VList[i]);
        }
    }
    ...
    )
    {
        ...
        for (uint32_t loopIdx = subblockIdx; loopIdx < tileLoops; loopIdx += subblockNum) {
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(eventUbCVMTE2List[ubListId]);
            copyGmToUbC(ubC, gmTileC, layoutUbC, layoutGmTileC);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>(eventUbCMTE2VList[ubListId]);
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(eventUbScaleVMTE2List[ubListId]);
            copyGmToUbScale(ubScale, gmTileScale, layoutUbScale, layoutGmTileScale);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>(eventUbScaleMTE2VList[ubListId]);
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(eventUbPerTokenScaleVMTE2List[ubListId]);
            copyGmToUbPerTokenScale(ubPerTokenScale, gmTilePerTokenScale, layoutUbPerTokenScale,
                layoutGmTilePerTokenScale);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>(eventUbPerTokenScaleMTE2VList[ubListId]);

            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>(eventUbCMTE2VList[ubListId]);
            AscendC::Cast(ubCFp32, ubC, AscendC::RoundMode::CAST_RINT, TileShape::COUNT);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(eventUbCVMTE2List[ubListId]);

            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>(eventUbScaleMTE2VList[ubListId]);
            AscendC::Cast(ubScaleFp32, ubScale, AscendC::RoundMode::CAST_NONE, TileShape::COLUMN);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(eventUbScaleVMTE2List[ubListId]);

            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>(eventUbPerTokenScaleMTE2VList[ubListId]);
            AscendC::Cast(ubPerTokenScaleFp32, ubPerTokenScale, AscendC::RoundMode::CAST_NONE, TileShape::ROW);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(eventUbPerTokenScaleVMTE2List[ubListId]);
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_V>(eventUbDMTE3VList[ubListId]);
            AscendC::Cast(ubD, ubPerTokenMul, AscendC::RoundMode::CAST_RINT, TileShape::COUNT);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE3>(eventUbDVMTE3List[ubListId]);

            auto gmTileD = gmD[params.layoutD.GetOffset(tileOffset)];
            auto layoutGmTileD = params.layoutD.GetTileLayout(actualTileShape);

            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE3>(eventUbDVMTE3List[ubListId]);
            copyUbToGmD(gmTileD, ubD, layoutGmTileD, layoutUbD);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_V>(eventUbDMTE3VList[ubListId]);
