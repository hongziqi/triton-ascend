...
public:
    ...
    void operator()<AscendC::AIC>(Params const& params)
    {
        ...
        for (uint32_t i = 0; i < L0C_TILE_NUM; i++) {
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::FIX_M>((event_t)i);
        }
        ...
        for (uint32_t loopIdx = AscendC::GetBlockIdx(); loopIdx < coreLoops; loopIdx += AscendC::GetBlockNum()) {
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::FIX_M>((event_t)singleIdx % L0C_TILE_NUM);
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::FIX_M>((event_t)singleIdx % L0C_TILE_NUM);
        ...
        #pragma unroll
        for (uint32_t i = 0; i < L0C_TILE_NUM; i++) {
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::FIX_M>((event_t)i);
        }
