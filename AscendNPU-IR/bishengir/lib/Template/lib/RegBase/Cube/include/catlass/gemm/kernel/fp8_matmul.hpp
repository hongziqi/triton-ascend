...
public:
    ...
    void operator()<AscendC::AIV>(Params const &params)
    {
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(EVENT_ID3);
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(EVENT_ID3);
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_V>(EVENT_ID2);
