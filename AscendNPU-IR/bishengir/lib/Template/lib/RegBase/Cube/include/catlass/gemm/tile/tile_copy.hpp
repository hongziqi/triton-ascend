...
struct QuantTileCopy : public TileCopy<ArchTag, AType, BType, CType, BiasType> {
    ...
    using CopyGmToL1Scale = Gemm::Tile::CopyGmToL1<ArchTag,
        Gemm::GemmType<uint64_t, layout::VectorLayout, AscendCBisheng::TPosition::GM>,
        Gemm::GemmType<uint64_t, layout::VectorLayout, AscendCBisheng::TPosition::A1>
    >;

    using CopyL1ToFB = Gemm::Tile::CopyL1ToFB<ArchTag,
        Gemm::GemmType<uint64_t, layout::VectorLayout, AscendCBisheng::TPosition::A1>,
        Gemm::GemmType<uint64_t, layout::VectorLayout, AscendCBisheng::TPosition::C2PIPE2GM>
    >;
};
#endif
...
struct PackedTileCopyTla {
    ...
    using TensorL1A =
        tla::Tensor<AscendC::LocalTensor<ElementA>, LayoutL1A, tla::Coord<tla::_0, tla::_0>, AscendCBisheng::TPosition::A1>;
    using TensorL1B =
        tla::Tensor<AscendC::LocalTensor<ElementB>, LayoutL1B, tla::Coord<tla::_0, tla::_0>, AscendCBisheng::TPosition::A1>;
    using TensorL0A =
        tla::Tensor<AscendC::LocalTensor<ElementA>, LayoutL0A, tla::Coord<tla::_0, tla::_0>, AscendCBisheng::TPosition::A2>;
    using TensorL0B =
        tla::Tensor<AscendC::LocalTensor<ElementB>, LayoutL0B, tla::Coord<tla::_0, tla::_0>, AscendCBisheng::TPosition::B2>;
