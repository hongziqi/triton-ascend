...
struct L1AndL0TypeSelectorGemv<Gemm::GemmType<Element, layout::VectorLayout>, Gemm::GemmType<Element, layout::RowMajor>>{
    ...
    using L1BType = Gemm::GemmType<Element, layout::zN, AscendCBisheng::TPosition::B1>;
    using L0AType = Gemm::GemmType<Element, layout::zZ, AscendCBisheng::TPosition::A2>;
    using L0BType = Gemm::GemmType<Element, layout::zN, AscendCBisheng::TPosition::B2>;
};

template<class Element>
struct L1AndL0TypeSelectorGemv<Gemm::GemmType<Element, layout::VectorLayout>, Gemm::GemmType<Element, layout::ColumnMajor>>{
    using L1AType = Gemm::GemmType<Element, layout::zN, AscendCBisheng::TPosition::A1>;
    using L1BType = Gemm::GemmType<Element, layout::nN, AscendCBisheng::TPosition::B1>;
    using L0AType = Gemm::GemmType<Element, layout::zZ, AscendCBisheng::TPosition::A2>;
    using L0BType = Gemm::GemmType<Element, layout::zN, AscendCBisheng::TPosition::B2>;
};
...
struct L1AndL0TypeSelectorGemv<Gemm::GemmType<int8_t, layout::VectorLayout>, Gemm::GemmType<int8_t, layout::ColumnMajor>>{
    ...
    using L0BType = Gemm::GemmType<int8_t, layout::zN, AscendCBisheng::TPosition::B2>;
};
