...
struct CopyL1ToL0A<ArchTag, Catlass::Gemm::GemmType<Element, layout::zN, AscendCBisheng::TPosition::A1>, Catlass::Gemm::GemmType<Element, layout::zZ, AscendCBisheng::TPosition::A2>>{
...
template<class ArchTag, class Element>
struct CopyL1ToL0A<ArchTag, Catlass::Gemm::GemmType<Element, layout::nN, AscendCBisheng::TPosition::A1>, Catlass::Gemm::GemmType<Element, layout::zZ, AscendCBisheng::TPosition::A2>>{
    using LayoutDst = layout::zZ;
...
struct CopyL1ToL0A<ArchTag, Catlass::Gemm::GemmType<float, layout::nN, AscendCBisheng::TPosition::A1>, Catlass::Gemm::GemmType<float, layout::zZ, AscendCBisheng::TPosition::A2>>{
    using Element = float;
    using LayoutDst = layout::zZ;
    using LayoutSrc = layout::nN;
...
template<class ArchTag>
struct CopyL1ToL0A<ArchTag, Catlass::Gemm::GemmType<int8_t, layout::nZ, AscendCBisheng::TPosition::A1>, Catlass::Gemm::GemmType<int8_t, layout::zZ, AscendCBisheng::TPosition::A2>>{
...
template<class ArchTag, class Element>
struct CopyL1ToL0A<ArchTag, Catlass::Gemm::GemmType<Element, layout::NDC1HWC0, AscendCBisheng::TPosition::A1>>{
    using LayoutDst = layout::zZ;
    ...
    void operator()(
        ...
        AscendCBisheng::LoadData<Element, CONV3D_LOAD3DV2_DEFAULT_CONFIG>(dstTensor, srcTensor, loadData3Dv2Params);
    }
private:
...
template <class ArchTag, class Element>
struct CopyL1ToL0A<ArchTag, Gemm::GemmType<Element, layout::zN, AscendCBisheng::TPosition::A1>> {
    using LayoutDst = layout::zZ;
    using LayoutSrc = layout::zN;
...
template <class ArchTag>
struct CopyL1ToL0A<ArchTag, Gemm::GemmType<float, layout::zN, AscendCBisheng::TPosition::A1>> {
    using Element = float;
    using LayoutDst = layout::zZ;
    using LayoutSrc = layout::zN;
...
template <class ArchTag, class Element>
struct CopyL1ToL0A<ArchTag, Gemm::GemmType<Element, layout::nZ, AscendCBisheng::TPosition::A1>> {
    using LayoutDst = layout::zZ;
    using LayoutSrc = layout::nZ;
...
template <class ArchTag>
struct CopyL1ToL0A<ArchTag, Gemm::GemmType<int8_t, layout::nZ, AscendCBisheng::TPosition::A1>> {
    using Element = int8_t;
    using LayoutDst = layout::zZ;
    using LayoutSrc = layout::nZ;
...
template <class ArchTag>
struct CopyL1ToL0A<ArchTag, Gemm::GemmType<float, layout::nZ, AscendCBisheng::TPosition::A1>> {
    using Element = float;
    using LayoutDst = layout::zZ;
    using LayoutSrc = layout::nZ;
...
struct TileCopyTla<Arch::AtlasA2,
    ...
    tla::Tensor<AscendC::LocalTensor<ElementDst>, LayoutDst, CoordDst, AscendCBisheng::TPosition::A2>,
...
struct TileCopyTla<Arch::AtlasA2,
    ...
    tla::Tensor<AscendC::LocalTensor<float>, LayoutDst, CoordDst, AscendCBisheng::TPosition::A2>,
...
struct TileCopyTla<Arch::AtlasA2,
    ...
    tla::Tensor<AscendC::LocalTensor<int8_t>, LayoutDst, CoordDst, AscendCBisheng::TPosition::A2>,
