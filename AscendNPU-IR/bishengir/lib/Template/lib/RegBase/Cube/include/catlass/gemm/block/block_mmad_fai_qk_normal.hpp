...
public:
    ...
    void loadQGM(AscendC::GlobalTensor<ElementA> gA, LayoutA layoutA, uint32_t rowNum, uint32_t &singleGroupHeads, uint32_t &qHeads){
        ...
        // AscendCBisheng::DataCopy(l1ATensor, gA, intriParams);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(EVENT_ID3);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(EVENT_ID3);
    }
        ...
        uint32_t &nkblockLoop, bool firstItr, bool endItr, bool initMmad, bool firstQItr, bool endQItr)
    {
        ...
        if (nkblockIdx != nkblockLoop) {
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(1 - l1KvPingPongFlag);
            copyGmToL1B(l1BTensor[1 - l1KvPingPongFlag], gmNextBlockB, layoutBNextInL1, layoutNextBTile);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(1 - l1KvPingPongFlag);
        }
        if(firstQItr) {
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1KvPingPongFlag);
