...
public:
                        ...
                        uint32_t &glFlag)
    {
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(oPingPangFlag);
        if (nIdx != NUM4) {
            AscendCBisheng::DataCopy(loUbTensor[oUbOffset], gInput,
                              AscendCBisheng::DataCopyParams(1, curRowNum * embedRound / FLOAT_BLOCK_SIZE, 0, 0));
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>(EVENT_ID0);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>(EVENT_ID0);
        }
        AscendC::SetVectorMask<int8_t>((uint64_t)-1, (uint64_t)-1);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(oPingPangFlag + 4);
        if (nIdx != NUM4) {
            AscendC::SetVectorMask<int8_t>((uint64_t)-1, (uint64_t)-1);
            ...
            if (needRowLoop) {
                AscendCBisheng::DataCopy(goUbTensor32[oUbOffset], gUpdate,
                                  AscendCBisheng::DataCopyParams(1, curRowNum * embedRound / FLOAT_BLOCK_SIZE, 0, 0));
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>(EVENT_ID0);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>(EVENT_ID0);
            }
            ...
            // *** gl = ll
            AscendCBisheng::DataCopy(goUbTensor32[oUbOffset], gInput,
                              AscendCBisheng::DataCopyParams(1, curRowNum * embedRound / FLOAT_BLOCK_SIZE, 0, 0));
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>(EVENT_ID0);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>(EVENT_ID0);
        }
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(oPingPangFlag);
        ...
        if (isLastNTile) {
            ...
            if (kvSplitCoreNum != 1) {
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE3>(EVENT_ID2);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE3>(EVENT_ID2);
                AscendC::DataCopyPad(gl, tvUbTensor,
                    AscendC::DataCopyExtParams(curRowNum, 4, 0, (kvSplitCoreNum - 1) * 4, 0));

                if (glFlag == 0) {
                    AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_V>(EVENT_ID2);
                    glFlag = 1;
                }
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_V>(EVENT_ID3);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_V>(EVENT_ID3);
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(EVENT_ID1);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(EVENT_ID1);
            } else {
                // *** go = castfp32to16(go)
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE3>(EVENT_ID5);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE3>(EVENT_ID5);
            AscendCBisheng::DataCopy(gUpdate, goUbTensor32[oUbOffset],
                              AscendCBisheng::DataCopyParams(1, curRowNum * embedRound / FLOAT_BLOCK_SIZE, 0, 0));
        }
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(oPingPangFlag + 4);
