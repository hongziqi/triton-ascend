...
public:
        ...
        GemmCoord actualShape, uint32_t &nIdx, Arch::CrossCoreFlag softmaxReady)
    {
        ...
        for (uint32_t embedSplitIdx = 0; embedSplitIdx < embedSplitLoopV; embedSplitIdx++) {
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(L0BPingPongFlag + 2);
            ...
            if (embedSplitIdx == 0) {
                ...
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(EVENT_ID7);
                // copy P to L1
                ...
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(L0APingPongFlag);
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(EVENT_ID7);
            }

            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_M>(L0BPingPongFlag);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_M>(L0BPingPongFlag);
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(L0BPingPongFlag + 2);
            if (embedSplitIdx == embedSplitLoopV - 1) {
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(L0APingPongFlag);
            }
