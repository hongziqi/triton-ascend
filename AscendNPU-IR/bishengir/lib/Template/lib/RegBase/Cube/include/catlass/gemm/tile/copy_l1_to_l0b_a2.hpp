...
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<Element, layout::zZ, AscendCBisheng::TPosition::B1>, Catlass::Gemm::GemmType<Element, layout::nZ, AscendCBisheng::TPosition::B2>>{
    ...
    void operator()(
        ...
        for(uint32_t i = 0; i < CeilDiv<C0_NUM_PER_FRACTAL>(layoutDst.orgShape(0)); i++){  // K N
            AscendCBisheng::LoadData(dstTensor[i * layoutDst.stride(1)], srcTensor[i * layoutSrc.stride(1)], loadDataParams);
        }
    }
};

template<class ArchTag>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<float, layout::zZ, AscendCBisheng::TPosition::B1>, Catlass::Gemm::GemmType<float, layout::nZ, AscendCBisheng::TPosition::B2>>{
    using Element = float;
    using LayoutDst = layout::nZ;
    using LayoutSrc = layout::zZ;
...
template<class ArchTag>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<int8_t, layout::zN, AscendCBisheng::TPosition::B1>, Catlass::Gemm::GemmType<int8_t, layout::nZ, AscendCBisheng::TPosition::B2>>{
...
template <class ArchTag, class Element>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<Element, layout::nZ, AscendCBisheng::TPosition::B1>, Catlass::Gemm::GemmType<Element, layout::nZ, AscendCBisheng::TPosition::B2>> {
    using LayoutDst = layout::nZ;
...
/// new add gemv
template <class ArchTag, class Element>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<Element, layout::zN, AscendCBisheng::TPosition::B1>, Catlass::Gemm::GemmType<Element, layout::zN, AscendCBisheng::TPosition::B2>>{
        ...
        LayoutDst const &layoutDst, LayoutSrc const &layoutSrc)
    {
        ...
        {
            AscendCBisheng::LoadData(dstTensor[i * layoutDst.stride(3)], srcTensor[i * layoutSrc.stride(3)], loadDataParams);
        }
    }
};

template <class ArchTag, class Element>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<Element, layout::nN, AscendCBisheng::TPosition::B1>, Catlass::Gemm::GemmType<Element, layout::zN, AscendCBisheng::TPosition::B2>>
{
    using LayoutDst = layout::zN;
        ...
        LayoutDst const &layoutDst, LayoutSrc const &layoutSrc)
    {
        ...
        loadDataParams.ifTranspose = true;
        loadDataParams.addrMode = 0;
        AscendCBisheng::LoadData(dstTensor, srcTensor, loadDataParams);
    };
};

template <class ArchTag>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<float, layout::nN, AscendCBisheng::TPosition::B1>, Catlass::Gemm::GemmType<float, layout::zN, AscendCBisheng::TPosition::B2>>{
    using LayoutDst = layout::zN;
    using LayoutSrc = layout::nN;
    using Element = float;
...
template <class ArchTag>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<int8_t, layout::nZ, AscendCBisheng::TPosition::B1>, Catlass::Gemm::GemmType<int8_t, layout::zN, AscendCBisheng::TPosition::B2>>{
    using LayoutDst = layout::zN;
    using LayoutSrc = layout::nZ;
    using Element = int8_t;
...
template <class ArchTag>
struct CopyL1ToL0B<ArchTag, Gemm::GemmType<int8_t, layout::zN, AscendCBisheng::TPosition::A1>> {
    using Element = int8_t;
    using LayoutDst = layout::nZ;
    using LayoutSrc = layout::zN;
...
template <class ArchTag>
struct CopyL1ToL0B<ArchTag, Gemm::GemmType<float, layout::zN, AscendCBisheng::TPosition::A1>> {
    using Element = float;
    using LayoutDst = layout::nZ;
    using LayoutSrc = layout::zN;
        ...
        LayoutDst const &layoutDst, LayoutSrc const &layoutSrc)
    {
        ...
        AscendCBisheng::LoadData<Element, config>(dstTensor, srcTensor, loadDataParams);
    }
};

/// Partial specialization for zN in and nZ out.
template <class ArchTag, class Element>
struct CopyL1ToL0B<ArchTag, Gemm::GemmType<Element, layout::zN, AscendCBisheng::TPosition::A1>> {
    using LayoutDst = layout::nZ;
    using LayoutSrc = layout::zN;
...
template <class ArchTag, class Element>
struct CopyL1ToL0B<ArchTag, Gemm::GemmType<Element, layout::nZ, AscendCBisheng::TPosition::A1>> {
    using LayoutDst = layout::nZ;
    using LayoutSrc = layout::nZ;
...
struct TileCopyTla<Arch::AtlasA2,
    ...
    tla::Tensor<AscendC::LocalTensor<ElementDst>, LayoutDst, CoordDst, AscendCBisheng::TPosition::B2>,
    ...
    void operator()(TensorDst const &dstTensor, TensorSrc const &srcTensor)
    {
        ...
        for (uint32_t i = 0; i < dstOuterShapeRow; i++) {
            AscendCBisheng::LoadData(dstTensor.data()[dstOffset + i * dstOuterStrideRow],
...
struct TileCopyTla<Arch::AtlasA2,
    ...
    void operator()(TensorDst const &dstTensor, TensorSrc const &srcTensor)
    {
        ...
        if (srcOuterStrideRow == dstOuterStrideRow) {
            ...
            AscendCBisheng::LoadData(dstTensor.data()[dstOffset], srcTensor.data()[srcOffset], loadDataParams);
        } else {
            loadDataParams.startIndex = 0;
            loadDataParams.repeatTimes = dstOuterShapeCol;
            loadDataParams.srcStride = 1;
...
struct TileCopyTla<Arch::AtlasA2,
    tla::Tensor<AscendC::LocalTensor<int8_t>, LayoutSrc, CoordSrc, AscendCBisheng::TPosition::A1>,
    tla::Tensor<AscendC::LocalTensor<int8_t>, LayoutDst, CoordDst, AscendCBisheng::TPosition::B2>,
...
template <class LayoutSrc, class LayoutDst, class CoordSrc, class CoordDst>
struct TileCopyTla<Arch::AtlasA2,
    tla::Tensor<AscendC::LocalTensor<float>, LayoutSrc, CoordSrc, AscendCBisheng::TPosition::A1>,
    tla::Tensor<AscendC::LocalTensor<float>, LayoutDst, CoordDst, AscendCBisheng::TPosition::B2>,
    ...
    void operator()(TensorDst const &dstTensor, TensorSrc const &srcTensor)
    {
        ...
        AscendCBisheng::LoadData<Element, config>(dstTensor.data()[dstOffset], srcTensor.data()[srcOffset], loadDataParams);
    }
};
