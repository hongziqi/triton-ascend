        ...
        bool isFirstBlock, bool hasNextBlock, uint32_t singleIdx)
    {
        ...
        for (uint32_t nLoopIdx = 0; nLoopIdx < nTileCount; nLoopIdx++) {
            ...
            for (uint32_t nPartIdx = 0; nPartIdx < nPartLoop; nPartIdx++) {
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_M>(l0AEventList[l0AListId]);
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_M>(l0BEventList[l0BListId]);
                ...
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_M>(l0BEventList[l0BListId]);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_M>(l0AEventList[l0AListId]);
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_FIX>((int32_t)(singleIdx % L0C_TILE_NUM));
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_FIX>((int32_t)(singleIdx % L0C_TILE_NUM));
