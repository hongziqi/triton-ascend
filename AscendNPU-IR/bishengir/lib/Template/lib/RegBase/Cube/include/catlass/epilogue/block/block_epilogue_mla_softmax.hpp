...
public:
        ...
        uint32_t kSeqTileRound)
    {
        if (kSeqTile <= FLOAT_VECTOR_SIZE) {
            ...
            AscendCBisheng::DataCopy(tempTensor, src, AscendCBisheng::DataCopyParams(curRowNum, HALF_VECTOR_SIZE / BLOCK_SIZE,
        ...
        uint32_t &glFlag)
    {
        ...
        AscendCBisheng::DataCopy(lsUbTensor, gInput,
                          AscendCBisheng::DataCopyParams(1, curRowNum * kSeqTileRound / FLOAT_BLOCK_SIZE, 0, 0));
        ...
        if (nIdx != 0) {
            ...
            AscendCBisheng::DataCopy(hmUbTensor, lmUbTensor, AscendCBisheng::DataCopyParams(1, subMRound / FLOAT_BLOCK_SIZE, 0, 0));
            AscendC::PipeBarrier<PIPE_V>();
        }
        // *** gm = hm
        AscendCBisheng::DataCopy(gmUbTensor, hmUbTensor, AscendCBisheng::DataCopyParams(1, subMRound / FLOAT_BLOCK_SIZE, 0, 0));
        AscendC::PipeBarrier<PIPE_V>();
        ...
        AscendCBisheng::DataCopy(gOutput,
                          tvUbTensor16,
