...
public:
                    ...
                    uint32_t &nIdx, uint32_t &nLoop, uint32_t &blockSize, uint32_t kvSeqlen)
    {
        ...
        if (nIdx == 0) {
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(EVENT_ID0);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(EVENT_ID0);
        }
        ...
        for (uint32_t blockStackIdx = 0; (blockStackIdx < UNIT_BLOCK_STACK_NUM) && ((nIdx + blockStackIdx) < nLoop);
            ...
            for (uint32_t embedSplitIdx = 0; embedSplitIdx < embedSplitLoopK; embedSplitIdx++) {
                ...
                // copy Q to l0a
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(L0ABPingPongFlag);
                ...
                if (embedSplitIdx == 0 || embedSplitIdx == 2) {
                    // copy K to l1b
                    AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(L1BPingPongFlag);
                    ...
                    AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(L1BPingPongFlag);
                    AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(L1BPingPongFlag);
                } else if (embedSplitIdx == 4) {
                    // copy KRope to L1
                    AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(L1BRopePingPongFlag + 2);
                    ...
                    copyGmToL1B(l1BRopeTensor[L1BRopePingPongFlag], gBRope[kvOffsetRope], layoutBRopeInL1,
                                layoutUnitBRope);
                    AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(L1BRopePingPongFlag);
                    AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(L1BRopePingPongFlag);
                }
                // copy K to l0b
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(L0ABPingPongFlag + 2);
                ...
                if (embedSplitIdx == 1 || embedSplitIdx == 3) {
                    AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(L1BPingPongFlag);
                } else if (embedSplitIdx == 4) {
                    AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(L1BRopePingPongFlag + 2);
                }
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_M>(L0ABPingPongFlag + 2);

                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_M>(L0ABPingPongFlag);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_M>(L0ABPingPongFlag + 2);
                if (embedSplitIdx == 0) {
                    AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::FIX_M>(L0CPingPongFlag);
                }
                // mmad
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(L0ABPingPongFlag);
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(L0ABPingPongFlag + 2);
            }
            // copy S to gm
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_FIX>(L0CPingPongFlag);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_FIX>(L0CPingPongFlag);
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::FIX_M>(L0CPingPongFlag);
        }
    }
