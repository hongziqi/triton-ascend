                ...
                void>
{
    ...
    )
    {
        ...
        ElementX pix[32];
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_S>((event_t)(0));
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_S>((event_t)(0));
        for (uint32_t i = 0; i < n_actual; i++)
        {
            pix[i] = srcTensor_v.GetValue(i);
        }
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::S_V>((event_t)(0));
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::S_V>((event_t)(0));
