...
struct PaddingMatrixNZ {
        ...
        ComputeLayoutDst const &layoutDst, ComputeLayoutDst const &layoutSrc)
    {
        if (layoutDst.stride(3) / ELE_NUM_PER_C0 < STRIDE_LIMIT) {
            ...
            AscendCBisheng::DataCopy(dst, src, dataCopyParams);
        } else {
            ...
            AscendCBisheng::DataCopyParams dataCopyParams(1, blockLen, 0, 0);
            for (uint32_t i = 0; i < blockCount; i++) {
                uint64_t dstOffset = i * layoutDst.stride(3);
                uint64_t srcOffset = i * layoutSrc.stride(3);
                AscendCBisheng::DataCopy(dst[dstOffset], src[srcOffset], dataCopyParams);
            }
        }
    }
        ...
        ComputeLayoutDst const &computeLayoutDst, ComputeLayoutSrc const &computeLayoutSrc)
    {
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(eventIds[0]);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(eventIds[1]);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_V>(eventIds[0]);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_V>(eventIds[1]);
        ...
        for (uint32_t loopIdx = aivId; loopIdx < totalTiles; loopIdx += aivNum) {
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(eventIds[bufferIndex]);
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>(eventIds[bufferIndex]);

            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_V>(eventIds[bufferIndex]);
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(eventIds[bufferIndex]);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE3>(eventIds[bufferIndex]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE3>(eventIds[bufferIndex]);
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_V>(eventIds[bufferIndex]);
            bufferIndex = 1 - bufferIndex;
        }

        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(eventIds[0]);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(eventIds[1]);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_V>(eventIds[0]);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_V>(eventIds[1]);
    }
...
public:
                    ...
                    LayoutOut const &layoutDst, LayoutIn const &layoutSrc)
    {
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(eventIds[0]);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(eventIds[1]);
        ...
        if (roundTileLen > COMPUTE_LENGTH) {
            ...
            for (uint32_t loopIdx = 0; loopIdx < coreLoops; ++loopIdx) {
                ...
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(eventIds[bufferIndex]);
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE3>(eventIds[bufferIndex]);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE3>(eventIds[bufferIndex]);
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(eventIds[0]);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(eventIds[1]);
    }
