...
public:
    ...
    BlockEpilogue(Arch::Resource<ArchTag> &resource, half tor_)
    {
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(EVENT_ID0);
    ...
    ~BlockEpilogue()
    {
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(EVENT_ID0);
        ...
        uint32_t nIdx, Arch::CrossCoreFlag qkReady)
    {
        ...
        if (subM > 0) {
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(pingpongFlag);
            // Copy QK
            ...
            if (nIdx == 0) {
                ...
                AscendCBisheng::DataCopy(
                    hmUbTensor, lmUbTensor, AscendCBisheng::DataCopyParams(1, subMRound / HALF_ELENUM_PER_BLK, 0, 0));
                AscendC::PipeBarrier<PIPE_V>();
            } else {
                // hm = vmax(lm, gm)
            ...
            // gm = hm
            AscendCBisheng::DataCopy(
                gmUbTensor, hmUbTensor, AscendCBisheng::DataCopyParams(1, subMRound / HALF_ELENUM_PER_BLK, 0, 0));
            AscendC::PipeBarrier<PIPE_V>();
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(pingpongFlag);
