...
public:
        ...
        uint32_t &nkblockLoop, bool firstItr, bool endItr, bool initMmad, bool pvCVItr, Arch::CrossCoreFlag softmaxFlag, bool preloadFlag = false)
    {
        ...
        if (nkblockIdx == 1 || preloadFlag) {
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1KvPingPongFlag + 2);
            copyGmToL1B(l1BTensor[l1KvPingPongFlag], gB, layoutBInL1, layoutBTile);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1KvPingPongFlag + 2);
        }

        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1KvPingPongFlag + 2);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(2);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(3);
        copyL1ToL0B(l0BTensor, l1BTensor[l1KvPingPongFlag], layoutBInL0, layoutBInL1);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1KvPingPongFlag + 2);

        if (pvCVItr) {
            Arch::CrossCoreWaitFlag(softmaxFlag);
        }
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1KvPingPongFlag + 4);
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(EVENT_ID5);
        ...
        if (nkblockIdx != nkblockLoop) {
            ...
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(1 - l1KvPingPongFlag + 2);
            copyGmToL1B(l1BTensor[1 - l1KvPingPongFlag], gmNextBlockB, layoutBNextInL1, layoutNextBTile);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(1 - l1KvPingPongFlag + 2);
        }

        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(EVENT_ID5);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(0);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(1);
        copyL1ToL0A(l0ATensor, l1ATensor[l1KvPingPongFlag], layoutAInL0, layoutAInL1);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1KvPingPongFlag + 4);

        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_M>(l0ABPingPongFlag);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_M>(l0ABPingPongFlag);
        uint8_t unitFlag = 0b00;
        if constexpr (!ENABLE_UNIT_FLAG_) {
            if (firstItr) {
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::FIX_M>(0);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::FIX_M>(1);
            }
        } else {
            if (endItr) {
                unitFlag = 0b11;
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(0);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(1);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(2);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(3);
        auto layoutInL0C = LayoutCInL0::MakeLayoutInL0C(MakeCoord(MActual, nActual));
        if (endItr) {
            if constexpr (!ENABLE_UNIT_FLAG_) {
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_FIX>(0);
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_FIX>(0);
                copyL0CToGm(gC, l0CTensor[0], layoutC, layoutInL0C);
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::FIX_M>(0);
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::FIX_M>(1);
            } else {
