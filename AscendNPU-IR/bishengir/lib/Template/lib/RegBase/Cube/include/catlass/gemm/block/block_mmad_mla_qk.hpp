...
public:
        ...
        uint32_t &qHeads, uint32_t &nIdx)
    {
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(l1KvPingPongFlag);
        // copy K to L1
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1KvPingPongFlag);
        ...
        for (uint32_t embedSplitIdx = 0; embedSplitIdx < embedSplitLoopK; embedSplitIdx++) {
            ...
            if (embedSplitIdx == 0) {
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_MTE1>(l1KvPingPongFlag);
            ...
            if (embedSplitIdx == 0) {
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::FIX_M>(l1KvPingPongFlag);
            }
            // mmad
            tileMmad(
        ...
        // copy S to gm
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_FIX>(l1KvPingPongFlag);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_FIX>(l1KvPingPongFlag);
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::FIX_M>(l1KvPingPongFlag);
    }
