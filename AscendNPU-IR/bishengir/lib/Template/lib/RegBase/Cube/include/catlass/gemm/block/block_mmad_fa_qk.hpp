...
public:
    ...
    BlockMmad(Arch::Resource<ArchTag> &resource, uint32_t l1BufAddrStart = 0)
    {
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(EVENT_ID0);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(EVENT_ID1);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(EVENT_ID0);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(EVENT_ID1);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::FIX_M>(EVENT_ID0);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::FIX_M>(EVENT_ID1);
    }
    ...
    ~BlockMmad()
    {
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(EVENT_ID0);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(EVENT_ID1);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(EVENT_ID0);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(EVENT_ID1);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::FIX_M>(EVENT_ID0);
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::FIX_M>(EVENT_ID1);
    }
        ...
        GemmCoord actualShape, uint32_t &pingpongFlag, bool isFirst)
    {
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::M_MTE1>(pingpongFlag);
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(pingpongFlag);
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE1_MTE2>(pingpongFlag);
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::FIX_M>(pingpongFlag);
        tileMmad(
            l0CTensor[pingpongFlag], l0ATensor[pingpongFlag], l0BTensor[pingpongFlag], mRound, nRound, actualShape.k());
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::M_MTE1>(pingpongFlag);
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::FIX_M>(pingpongFlag);
