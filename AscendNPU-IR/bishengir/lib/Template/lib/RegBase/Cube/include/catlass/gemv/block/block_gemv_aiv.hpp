...
public:
    ...
    BlockGemv(Arch::Resource<ArchTag> &resource, uint32_t UBufAddrStart = 0)
    {
        ...
        for (uint32_t i = 0; i < STAGES; i++) {
            ...
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(UbInAEventList[i]);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>(UbInXEventList[i]);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(UbOutEventList[i]);
        }
    }
    ...
    {
        for (uint32_t i = 0; i < STAGES; i++) {
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(UbInAEventList[i]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>(UbInXEventList[i]);
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_MTE2>(UbOutEventList[i]);
        }
    }
    ...
    void operator()(
        ...
        float beta)
    {
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE3_MTE2>((event_t)(UbOutEventList[UbOutListId]));
        vecCopyGmToUb(UbYTensorList[UbOutListId], gmY, actualShape.m());
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>((event_t)(UbOutEventList[UbOutListId]));
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>((event_t)(UbOutEventList[UbOutListId]));
        tileVmuls(UbYTensorList[UbOutListId], UbYTensorList[UbOutListId], (ElementY)beta, actualShape.m());
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>((event_t)(UbOutEventList[UbOutListId]));
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>((event_t)(UbOutEventList[UbOutListId]));
        ...
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>((event_t)(UbInXEventList[UbInListId]));
        vecCopyGmToUb(UbXTensorList[UbInListId], gmX, n_actual);
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>((event_t)(UbInXEventList[UbInListId]));

        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>((event_t)(UbInAEventList[UbInListId]));
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>((event_t)(UbInAEventList[UbInListId]));
        // main loop
        ...
        for (uint32_t LoopIdx = 0; LoopIdx < Nloop; LoopIdx++) {
            ...
            if (LoopIdx < Nloop - 1) {
                ...
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>((event_t)(UbInXEventList[UbInListIdNext]));
                vecCopyGmToUb(vecTensor, gmX[LoopIdxNext * TileNRound], x_actual_next);
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>((event_t)(UbInXEventList[UbInListIdNext]));
                AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE2>((event_t)(UbInAEventList[UbInListIdNext]));
                auto layoutAInUb = layoutA.GetTileLayout(MakeCoord(TileMRound, TileNRound));
                ...
                AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE2_V>((event_t)(UbInAEventList[UbInListIdNext]));
            }
            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>((event_t)(UbInXEventList[UbInListId]));
            tileVmuls(UbXTensorList[UbInListId], UbXTensorList[UbInListId], (ElementA)alpha, x_actual);
            AscendC::PipeBarrier<PIPE_V>();

            AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::MTE2_V>((event_t)(UbInAEventList[UbInListId]));
            ...
            tileVmad(UbYTensorList[UbOutListId],
                ...
                layoutComputeInUb,
                layoutTileCompute);
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>((event_t)(UbInAEventList[UbInListId]));
            AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE2>((event_t)(UbInXEventList[UbInListId]));
            UbInListId = UbInListIdNext;
        }
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::V_MTE3>((event_t)(UbOutEventList[UbOutListId]));
        AscendCBisheng::WaitFlag<AscendCBisheng::HardEvent::V_MTE3>((event_t)(UbOutEventList[UbOutListId]));
        ...
        AscendCBisheng::SetFlag<AscendCBisheng::HardEvent::MTE3_MTE2>((event_t)(UbOutEventList[UbOutListId]));
