...
DECLARE_NZ2ND(float, 5, 3);
DECLARE_NZ2ND(bfloat16_t, 5, 3);
DECLARE_NZ2ND(half, 5, 3);
DECLARE_NZ2ND(int8_t, 5, 3);
DECLARE_NZ2ND(uint8_t, 5, 3);
DECLARE_NZ2ND(int16_t, 5, 3);
DECLARE_NZ2ND(uint16_t, 5, 3);
DECLARE_NZ2ND(int32_t, 5, 3);
DECLARE_NZ2ND(uint32_t, 5, 3);
DECLARE_NZ2ND(int64_t, 5, 3);
DECLARE_NZ2ND(uint64_t, 5, 3);
}
