...
```bash
lit -v build/cmake.*/ascend/unittest --filter=LLVM20Compat
```

2. Single-file debug:

```bash
triton-opt ascend/unittest/Conversion/LLVM20Compat/OpCompat/arith_divsi.mlir \
  | FileCheck ascend/unittest/Conversion/LLVM20Compat/OpCompat/arith_divsi.mlir
```
